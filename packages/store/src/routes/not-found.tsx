  ...
  return (
    <div className="flex flex-col items-center justify-center text-center p-8 bg-[#161b22] border border-rose-500/30 rounded-xl shadow-lg my-4">
      ...
      <p className="text-slate-400 text-xs sm:text-sm max-w-md mb-5">
        ...
        <strong className="text-slate-200">Store Micro-Frontend</strong>.
      </p>
      ...
      <div className="bg-[#0d1117] border border-[#30363d] rounded-lg p-3 text-xs text-slate-400 font-mono mb-6 text-left w-full max-w-md">
        ...
        <div className="flex justify-between py-0.5">
          ...
          <span className="text-emerald-400 font-semibold">@app/store</span>
        </div>
        <div className="flex justify-between py-0.5">
          <span>Basepath:</span>
          <span className="text-sky-400 font-semibold">/store</span>
        </div>
        <div className="flex justify-between py-0.5">
      ...
      <div className="flex flex-wrap items-center justify-center gap-2.5">
        <Link
          to="/"
          className="bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-semibold px-4 py-2 rounded-lg text-xs transition-colors shadow-sm"
        >
