			...
			<section className="bg-[#161b22] border border-[#30363d] rounded-xl p-5 shadow-lg flex flex-col gap-4">
				...
				<div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs font-mono">
					<div className="bg-[#0d1117] p-3 rounded-lg border border-[#30363d]">
						...
						<div className="text-pink-300 font-bold mt-1">Bun v{serverInfo?.bunVersion || '1.4.0'}</div>
					</div>
					<div className="bg-[#0d1117] p-3 rounded-lg border border-[#30363d]">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
				...
				<section className="bg-[#161b22] border border-[#30363d] rounded-xl p-5 shadow-lg flex flex-col justify-between gap-4">
					<div>
						...
						<p className="text-xs text-slate-300 mt-1 leading-relaxed">
							TanStack Router handles routing purely in-memory on the client. State persists and transitions occur with
							zero page reloads.
						</p>
					</div>
				...
				<section className="bg-[#161b22] border border-[#30363d] rounded-xl p-5 shadow-lg flex flex-col justify-between gap-4">
					<div>
						...
						<p className="text-xs text-slate-300 mt-1 leading-relaxed">
							Navigating across micro-frontends loads the respective MFE package bundle hosted under scoped sub-paths by
							the Bun server.
						</p>
					</div>
