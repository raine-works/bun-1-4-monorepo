	...
	return (
		<div className="flex flex-col items-center justify-center text-center p-8 bg-[#161b22] border border-rose-500/30 rounded-xl shadow-lg my-4">
			...
			<p className="text-slate-300 text-xs sm:text-sm max-w-md mb-5">
				...
				does not match any registered route in the <strong className="text-white">Hub Micro-Frontend</strong>.
			</p>
			...
			<div className="bg-[#0d1117] border border-[#30363d] rounded-lg p-3 text-xs text-slate-300 font-mono mb-6 text-left w-full max-w-md">
				...
				<div className="flex justify-between py-0.5">
					...
					<span className="text-pink-300 font-semibold">@app/hub</span>
				</div>
				<div className="flex justify-between py-0.5">
					<span>Basepath:</span>
			...
			<div className="flex flex-wrap items-center justify-center gap-2.5">
				<Link
					to="/"
					aria-label="Return to Hub Home"
					className="bg-pink-500 hover:bg-pink-400 text-slate-950 font-semibold px-4 py-2 rounded-lg text-xs transition-colors shadow-sm min-h-[36px] inline-flex items-center"
				>
